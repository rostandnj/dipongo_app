...
export default function  Onboarding () {
    ...
    const [textOnboard,setTextOnboard] = useState("Viens nous rejoindre dans l'équipe, tu vas découvrir un métier passionnant. Allez en route je n'ai que 50 min pour te former, tu devras être attentif.")
    ...
    if(session){
        return (
            ...
            <Layout className="bgapp onboard-layout background-onboard2"
            >
                <section className={"hv100 column onboard-page flex itemcenter justcenter"} >
                    ...
                    <div className="flex h100 w100  justcenter" style={{alignItems:'flex-end',paddingRight: '4px'}}>
                        ...
                        <div className="onboard-div card-auth hauto w100 bgwhite " style={{position:'relative',marginBottom:45}}>
                        <span className="onboarding-text">
                            {textOnboard}
                        </span>


                            <Link href={'/onboard/step-4'}>
