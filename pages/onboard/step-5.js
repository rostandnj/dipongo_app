...
export default function  Onboarding () {
    ...
    const [textOnboard,setTextOnboard] = useState("Dans chacun d'eux tu devras récolter un maximum de bouées tubes pour valider le lieu. Pour gagner des bouées tubes tu devras répondre à mes questions et relever mes défis.")
    const [loading,setLoading] = useState(false)

    if(session){
        return (
            <Layout className="bgapp onboard-layout background-onboard5"
            >
